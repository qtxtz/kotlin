...
abstract class AbstractNativeCInteropNoFModulesLegacyMacroCollectionTest : AbstractNativeCInteropNoFModulesTest() {
    override val macroCollectionImpl: String = "legacy"
}

abstract class AbstractNativeCInteropNoFModulesLibclangextMacroCollectionTest : AbstractNativeCInteropNoFModulesTest() {
    override val macroCollectionImpl: String = "libclangext"
}

abstract class AbstractNativeCInteropNoFModulesLibclangextParallelMacroCollectionTest : AbstractNativeCInteropNoFModulesTest() {
    override val macroCollectionImpl: String = "libclangext_parallel"
}
...
abstract class AbstractNativeCInteropTest : AbstractNativeCInteropBaseTest() {
    ...
    open val macroCollectionImpl: String
        get() = ""
    ...
    protected fun runTest(@TestDataFile testPath: String) {
        ...
        val macroCollectionImplArgs =
            macroCollectionImpl.takeIf { it.isNotEmpty() }?.let { TestCInteropArgs("-Xmacro-collection-impl", it) }
