...
abstract class AbstractNativeCInteropFModulesLibclangextMacroCollectionTest : AbstractNativeCInteropFModulesTest() {
    override val macroCollectionImpl: String = "libclangext"
}

abstract class AbstractNativeCInteropFModulesLibclangextParallelMacroCollectionTest : AbstractNativeCInteropFModulesTest() {
...
abstract class AbstractNativeCInteropTest : AbstractNativeCInteropBaseTest() {
    ...
    protected fun runTest(@TestDataFile testPath: String) {
        ...
        val macroCollectionImplArgs = macroCollectionImpl?.let { TestCInteropArgs("-Xmacro-collection-impl", it) }
