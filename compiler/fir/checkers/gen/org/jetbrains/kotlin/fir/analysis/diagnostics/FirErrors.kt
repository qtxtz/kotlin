...
object FirErrors : KtDiagnosticsContainer() {
    ...
    val UPPER_BOUND_VIOLATED_IN_LHS_OF_CLASS_LITERAL_WARNING: KtDiagnosticFactory2<ConeKotlinType, ConeKotlinType> = KtDiagnosticFactory2("UPPER_BOUND_VIOLATED_IN_LHS_OF_CLASS_LITERAL_WARNING", WARNING, SourceElementPositioningStrategies.DEFAULT, PsiElement::class, getRendererFactory())
