...
internal abstract class CommonCompilerArgumentsImpl(
  ...
  override fun toCompilationInputs(): Map<String, String> = super.toCompilationInputs() + buildMap {
    ...
    if (XX_EXPLICIT_RETURN_TYPES in this@CommonCompilerArgumentsImpl) put(XX_EXPLICIT_RETURN_TYPES.id, this@CommonCompilerArgumentsImpl[XX_EXPLICIT_RETURN_TYPES].toString())
    ...
    try { if (X_COLLECTION_LITERALS in this@CommonCompilerArgumentsImpl) put(X_COLLECTION_LITERALS.id, this@CommonCompilerArgumentsImpl[X_COLLECTION_LITERALS].toString()) } catch (_: NoSuchMethodError) {  }
    ...
    try { if (X_COMPILER_PLUGIN_ORDER in this@CommonCompilerArgumentsImpl) put(X_COMPILER_PLUGIN_ORDER.id, this@CommonCompilerArgumentsImpl[X_COMPILER_PLUGIN_ORDER]?.contentToString() ?: "null") } catch (_: NoSuchMethodError) {  }
    if (X_CONSISTENT_DATA_CLASS_COPY_VISIBILITY in this@CommonCompilerArgumentsImpl) put(X_CONSISTENT_DATA_CLASS_COPY_VISIBILITY.id, this@CommonCompilerArgumentsImpl[X_CONSISTENT_DATA_CLASS_COPY_VISIBILITY].toString())
    ...
    if (X_DIRECT_JAVA_ACTUALIZATION in this@CommonCompilerArgumentsImpl) put(X_DIRECT_JAVA_ACTUALIZATION.id, this@CommonCompilerArgumentsImpl[X_DIRECT_JAVA_ACTUALIZATION].toString())
    ...
    try { if (X_DONT_SORT_SOURCE_FILES in this@CommonCompilerArgumentsImpl) put(X_DONT_SORT_SOURCE_FILES.id, this@CommonCompilerArgumentsImpl[X_DONT_SORT_SOURCE_FILES].toString()) } catch (_: NoSuchMethodError) {  }
    if (X_DONT_WARN_ON_ERROR_SUPPRESSION in this@CommonCompilerArgumentsImpl) put(X_DONT_WARN_ON_ERROR_SUPPRESSION.id, this@CommonCompilerArgumentsImpl[X_DONT_WARN_ON_ERROR_SUPPRESSION].toString())
    ...
    if (X_EXPECT_ACTUAL_CLASSES in this@CommonCompilerArgumentsImpl) put(X_EXPECT_ACTUAL_CLASSES.id, this@CommonCompilerArgumentsImpl[X_EXPECT_ACTUAL_CLASSES].toString())
    ...
    try { if (X_EXPLICIT_BACKING_FIELDS in this@CommonCompilerArgumentsImpl) put(X_EXPLICIT_BACKING_FIELDS.id, this@CommonCompilerArgumentsImpl[X_EXPLICIT_BACKING_FIELDS].toString()) } catch (_: NoSuchMethodError) {  }
    try { if (X_EXPLICIT_CONTEXT_ARGUMENTS in this@CommonCompilerArgumentsImpl) put(X_EXPLICIT_CONTEXT_ARGUMENTS.id, this@CommonCompilerArgumentsImpl[X_EXPLICIT_CONTEXT_ARGUMENTS].toString()) } catch (_: NoSuchMethodError) {  }
    ...
    try { if (X_FRAGMENT_FRIEND_DEPENDENCY in this@CommonCompilerArgumentsImpl) put(X_FRAGMENT_FRIEND_DEPENDENCY.id, this@CommonCompilerArgumentsImpl[X_FRAGMENT_FRIEND_DEPENDENCY]?.contentToString() ?: "null") } catch (_: NoSuchMethodError) {  }
    ...
    try { if (X_HEADER_MODE in this@CommonCompilerArgumentsImpl) put(X_HEADER_MODE.id, this@CommonCompilerArgumentsImpl[X_HEADER_MODE].toString()) } catch (_: NoSuchMethodError) {  }
    try { if (X_HEADER_MODE_TYPE in this@CommonCompilerArgumentsImpl) put(X_HEADER_MODE_TYPE.id, this@CommonCompilerArgumentsImpl[X_HEADER_MODE_TYPE].toString()) } catch (_: NoSuchMethodError) {  }
    ...
    try { if (X_LOCAL_TYPE_ALIASES in this@CommonCompilerArgumentsImpl) put(X_LOCAL_TYPE_ALIASES.id, this@CommonCompilerArgumentsImpl[X_LOCAL_TYPE_ALIASES].toString()) } catch (_: NoSuchMethodError) {  }
    if (X_METADATA_KLIB in this@CommonCompilerArgumentsImpl) put(X_METADATA_KLIB.id, this@CommonCompilerArgumentsImpl[X_METADATA_KLIB].toString())
    ...
    if (X_MULTI_DOLLAR_INTERPOLATION in this@CommonCompilerArgumentsImpl) put(X_MULTI_DOLLAR_INTERPOLATION.id, this@CommonCompilerArgumentsImpl[X_MULTI_DOLLAR_INTERPOLATION].toString())
    ...
    try { if (X_NAME_BASED_DESTRUCTURING in this@CommonCompilerArgumentsImpl) put(X_NAME_BASED_DESTRUCTURING.id, this@CommonCompilerArgumentsImpl[X_NAME_BASED_DESTRUCTURING].toString()) } catch (_: NoSuchMethodError) {  }
    ...
    if (X_NON_LOCAL_BREAK_CONTINUE in this@CommonCompilerArgumentsImpl) put(X_NON_LOCAL_BREAK_CONTINUE.id, this@CommonCompilerArgumentsImpl[X_NON_LOCAL_BREAK_CONTINUE].toString())
    ...
    try { if (X_REPL in this@CommonCompilerArgumentsImpl) put(X_REPL.id, this@CommonCompilerArgumentsImpl[X_REPL].toString()) } catch (_: NoSuchMethodError) {  }
    ...
    if (X_STDLIB_COMPILATION in this@CommonCompilerArgumentsImpl) put(X_STDLIB_COMPILATION.id, this@CommonCompilerArgumentsImpl[X_STDLIB_COMPILATION].toString())
    if (X_SUPPRESS_API_VERSION_GREATER_THAN_LANGUAGE_VERSION_ERROR in this@CommonCompilerArgumentsImpl) put(X_SUPPRESS_API_VERSION_GREATER_THAN_LANGUAGE_VERSION_ERROR.id, this@CommonCompilerArgumentsImpl[X_SUPPRESS_API_VERSION_GREATER_THAN_LANGUAGE_VERSION_ERROR].toString())
    ...
    if (X_SUPPRESS_WARNING in this@CommonCompilerArgumentsImpl) put(X_SUPPRESS_WARNING.id, this@CommonCompilerArgumentsImpl[X_SUPPRESS_WARNING]?.contentToString() ?: "null")
    ...
    if (X_USE_FIR_EXPERIMENTAL_CHECKERS in this@CommonCompilerArgumentsImpl) put(X_USE_FIR_EXPERIMENTAL_CHECKERS.id, this@CommonCompilerArgumentsImpl[X_USE_FIR_EXPERIMENTAL_CHECKERS].toString())
    ...
    if (X_VERIFY_IR in this@CommonCompilerArgumentsImpl) put(X_VERIFY_IR.id, this@CommonCompilerArgumentsImpl[X_VERIFY_IR].toString())
    try { if (X_VERIFY_IR_NESTED_OFFSETS in this@CommonCompilerArgumentsImpl) put(X_VERIFY_IR_NESTED_OFFSETS.id, this@CommonCompilerArgumentsImpl[X_VERIFY_IR_NESTED_OFFSETS].toString()) } catch (_: NoSuchMethodError) {  }
    if (X_VERIFY_IR_VISIBILITY in this@CommonCompilerArgumentsImpl) put(X_VERIFY_IR_VISIBILITY.id, this@CommonCompilerArgumentsImpl[X_VERIFY_IR_VISIBILITY].toString())
    ...
    if (X_WHEN_GUARDS in this@CommonCompilerArgumentsImpl) put(X_WHEN_GUARDS.id, this@CommonCompilerArgumentsImpl[X_WHEN_GUARDS].toString())
