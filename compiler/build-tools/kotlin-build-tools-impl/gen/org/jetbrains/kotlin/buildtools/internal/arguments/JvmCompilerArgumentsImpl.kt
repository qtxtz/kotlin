...
internal class JvmCompilerArgumentsImpl(
  ...
  override fun toCompilationInputs(): Map<String, String> = super.toCompilationInputs() + buildMap {
    ...
    try { if (X_IGNORED_ANNOTATIONS_FOR_BRIDGES in this@JvmCompilerArgumentsImpl) put(X_IGNORED_ANNOTATIONS_FOR_BRIDGES.id, this@JvmCompilerArgumentsImpl[X_IGNORED_ANNOTATIONS_FOR_BRIDGES]?.contentToString() ?: "null") } catch (_: NoSuchMethodError) {  }
    ...
    if (X_USE_INLINE_SCOPES_NUMBERS in this@JvmCompilerArgumentsImpl) put(X_USE_INLINE_SCOPES_NUMBERS.id, this@JvmCompilerArgumentsImpl[X_USE_INLINE_SCOPES_NUMBERS].toString())
    ...
    if (EXPRESSION in this@JvmCompilerArgumentsImpl) put(EXPRESSION.id, this@JvmCompilerArgumentsImpl[EXPRESSION].toString())
