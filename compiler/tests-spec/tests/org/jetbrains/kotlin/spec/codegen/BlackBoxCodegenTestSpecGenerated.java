    ...
    public static class Linked extends AbstractBlackBoxCodegenTestSpec {
        ...
        public static class Type_system extends AbstractBlackBoxCodegenTestSpec {
            ...
            public static class Type_kinds extends AbstractBlackBoxCodegenTestSpec {
                ...
                @TestMetadata("compiler/tests-spec/testData/codegen/box/linked/type-system/type-kinds/build-in-types")
                @TestDataPath("$PROJECT_ROOT")
                @RunWith(JUnit3RunnerWithInners.class)
                public static class Build_in_types extends AbstractBlackBoxCodegenTestSpec {
                    private void runTest(String testDataFilePath) throws Exception {
                        KotlinTestUtils.runTest(this::doTest, this, testDataFilePath);
                    }

                    public void testAllFilesPresentInBuild_in_types() throws Exception {
                        KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/tests-spec/testData/codegen/box/linked/type-system/type-kinds/build-in-types"), Pattern.compile("^(.+)\\.kt$"), true);
                    }

                    @TestMetadata("compiler/tests-spec/testData/codegen/box/linked/type-system/type-kinds/build-in-types/kotlin.nothing")
                    @TestDataPath("$PROJECT_ROOT")
                    @RunWith(JUnit3RunnerWithInners.class)
                    public static class Kotlin_nothing extends AbstractBlackBoxCodegenTestSpec {
                        ...
                        public void testAllFilesPresentInKotlin_nothing() throws Exception {
                            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/tests-spec/testData/codegen/box/linked/type-system/type-kinds/build-in-types/kotlin.nothing"), Pattern.compile("^(.+)\\.kt$"), true);
                        }

                        @TestMetadata("compiler/tests-spec/testData/codegen/box/linked/type-system/type-kinds/build-in-types/kotlin.nothing/pos")
                        @TestDataPath("$PROJECT_ROOT")
                        @RunWith(JUnit3RunnerWithInners.class)
                        public static class Pos extends AbstractBlackBoxCodegenTestSpec {
                            private void runTest(String testDataFilePath) throws Exception {
                            ...
                            public void testAllFilesPresentInPos() throws Exception {
                                KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/tests-spec/testData/codegen/box/linked/type-system/type-kinds/build-in-types/kotlin.nothing/pos"), Pattern.compile("^(.+)\\.kt$"), true);
                            }
                        }
                    }
                }
