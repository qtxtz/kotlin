    ...
    when (leftType) {
        ...
        BYTE -> when (rightType) {
            BYTE -> when (name) {
                ...
                "and" -> return (left as Byte).and(right as Byte)
                "or" -> return (left as Byte).or(right as Byte)
        ...
        SHORT -> when (rightType) {
            ...
            SHORT -> when (name) {
                ...
                "and" -> return (left as Short).and(right as Short)
                "or" -> return (left as Short).or(right as Short)
...
private val knownOps = setOf(
    ...
    "kotlin/toULong(LONG)",
    "kotlin/toUInt(LONG)",
    "kotlin/toUShort(LONG)",
    "kotlin/toUByte(LONG)",
    "kotlin/toULong(INT)",
    "kotlin/toUInt(INT)",
    "kotlin/toUShort(INT)",
    "kotlin/toUByte(INT)",
    "kotlin/toULong(SHORT)",
    "kotlin/toUInt(SHORT)",
    "kotlin/toUShort(SHORT)",
    "kotlin/toUByte(SHORT)",
    "kotlin/toULong(BYTE)",
    "kotlin/toUInt(BYTE)",
    "kotlin/toUShort(BYTE)",
    "kotlin/toUByte(BYTE)",
    "kotlin/toULong(DOUBLE)",
    "kotlin/toUInt(DOUBLE)",
    "kotlin/toULong(FLOAT)",
    "kotlin/toUInt(FLOAT)",
    ...
    "kotlin/experimental/and(SHORT, SHORT)",
    "kotlin/experimental/or(SHORT, SHORT)",
    "kotlin/experimental/xor(SHORT, SHORT)",
    "kotlin/experimental/and(BYTE, BYTE)",
    "kotlin/experimental/or(BYTE, BYTE)",
    "kotlin/experimental/xor(BYTE, BYTE)",
