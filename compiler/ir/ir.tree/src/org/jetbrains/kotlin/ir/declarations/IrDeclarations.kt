 ...
 *  1. Copies [IrAttribute]s of [other] into [this]. See kdoc of [copyAttributesWithoutOwnerId] for details.
...
/**
 * Copies [IrAttribute]s of element [other] into [this]. Attributes already present on [this] are not removed, attributes present
 ...
 */
fun IrElement.copyAttributesWithoutOwnerId(other: IrElement, includeAll: Boolean = false) {
    (this as IrElementBase).copyAttributesFrom(other as IrElementBase, includeAll)
}
