...
abstract class IrMemberAccessExpression<S : IrSymbol> : IrDeclarationReference() {
    ...
    fun initializeTargetShapeFromSymbol() {
        ...
        when (target) {
            ...
            // This branch won't be needed once old IR callable references (IrPropertyReferenceImpl etc.) are dropped.
            is IrProperty -> {
    ...
    private fun hasDispatchReceiver(): Boolean {
        ...
        return when (target) {
            ...
            // These two branches won't be needed once old IR callable references (IrPropertyReferenceImpl etc.) are dropped.
            is IrProperty -> {
