...
public class SymbolLightClassesMatcherByPsiForLibraryTestGenerated extends AbstractSymbolLightClassesMatcherByPsiForLibraryTest {
  ...
  public class VersionOverloads {
    ...
    public void testAllFilesPresentInVersionOverloads() {
      KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/asJava/lightClasses/lightClassByPsi/versionOverloads"), Pattern.compile("^([^.]+)\\.kt$"), null, true);
    }
