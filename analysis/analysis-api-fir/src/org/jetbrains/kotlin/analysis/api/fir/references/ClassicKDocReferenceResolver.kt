...
/**
 * This is the former implementation of [KDocReferenceResolver], which was used before KT-76607.
 * We need to keep it in the code base for the migration purposes, so that we can easily switch between
 * two resolution strategies during our dog-fooding period.
 */
...
internal object ClassicKDocReferenceResolver {
    ...
    private fun KaSession.resolveKdocFqName(
        ...
        KDocReferenceResolver.resolveKdocFqName(useSiteSession, fqName, contextElement)
