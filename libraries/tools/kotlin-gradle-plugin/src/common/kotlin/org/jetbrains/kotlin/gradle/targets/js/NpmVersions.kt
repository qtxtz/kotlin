...
class NpmVersions : Serializable {
    ...
    val swcHelpers = NpmPackageVersion("@swc/helpers", "0.5.21")
    val webpackCli = NpmPackageVersion("webpack-cli", "7.0.2")
    ...
    val typescript = NpmPackageVersion("typescript", "6.0.3")
